...
from .text_utils import normalizar_chave, remover_acentos, _to_float_br
...
class ExcelReader:
    """Thin wrapper around pd.read_excel used by tarifas modules."""

    @staticmethod
    def read(path, sheet_name=0, header=0, **kwargs):
