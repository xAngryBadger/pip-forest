"""
SRF constants — large data dictionaries extracted from the monolith.

These are pure data (no code logic) and can be safely moved to
YAML/JSON files in the future without changing any logic.

IMPORTANT: The original monolith uses accented strings as dictionary keys
...
# ═══════════════════════════════════════════════════════════════════════════════
# DE-PARA: micro activity names -> CT317 canonical operation names
# ═══════════════════════════════════════════════════════════════════════════════
...
"adubacao quim man de base impl pl ap": "ADUBAÇÃO QUÍM MAN DE BASE Impl. PL - APP/ RL",
"adubacao quim man de base impl cd ap": "ADUBAÇÃO QUÍM MAN DE BASE Impl. CD - APP/ RL",
"controle formiga impl pl ap": "COMBATE À FORMIGAS Impl. PL APP/ RL",
"controle formiga impl cd ap": "COMBATE À FORMIGAS Impl. CD APP/RL",
"controle formiga impl mx ap": "COMBATE À FORMIGAS Impl. PL APP/ RL",
"controle formiga impl pt ap": "COMBATE À FORMIGAS MAdap. APP/RL",
"controle formiga impl mo ap": "COMBATE À FORMIGAS MAdap. APP/RL",
"controle formiga impl ca ap": "COMBATE À FORMIGAS Impl. CD APP/RL",
"controle formiga madap ap": "COMBATE À FORMIGAS MAdap. APP/RL",
"controle formiga manut ap": "COMBATE À FORMIGAS Manut. APP/RL",
"combate a formiga impl pl ap": "COMBATE À FORMIGAS Impl. PL APP/ RL",
"combate a formiga impl cd ap": "COMBATE À FORMIGAS Impl. CD APP/RL",
"plantio manual impl pl ap": "PLANTIO MANUAL APP/RL",
"plantio manual impl cd ap": "PLANTIO MANUAL APP/RL",
"plantio manual impl mx ap": "PLANTIO MANUAL APP/RL",
"plantio manual impl pt ap": "PLANTIO MANUAL APP/RL",
"plantio manual impl mo ap": "PLANTIO MANUAL APP/RL",
"plantio manual impl ca ap": "PLANTIO MANUAL APP/RL",
"replantio manual impl pl ap": "REPLANTIO APP/RL I",
"replantio manual impl cd ap": "REPLANTIO APP/RL I",
"replantio manual impl mx ap": "REPLANTIO APP/RL I",
"replantio manual impl pt ap": "REPLANTIO APP/RL I",
"replantio manual impl mo ap": "REPLANTIO APP/RL I",
"replantio manual impl ca ap": "REPLANTIO APP/RL I",
"rocada manual impl pl ap": "ROÇADA MANUAL Impl. PL APP/RL I",
"rocada manual impl cd ap": "ROÇADA MANUAL Impl. CD APP/RL I",
"capina manual coroa impl pl ap": "CAPINA MANUAL COROA Impl. PL - APP/ RL I",
"capina manual coroa impl cd ap": "CAPINA MANUAL COROA Impl. CD APP/ RL I",
"capina quim man total impl pl ap": "CAPINA QUÍM MAN TOTAL Manut. APP/RL",
"capina quim man total impl cd ap": "CAPINA QUÍM MAN TOTAL Manut. APP/RL",
"capina quim man total madap ap": "CAPINA QUÍM MAN TOTAL MAdap. APP/RL",
"irrigacao inicial man impl pl ap": "IRRIGAÇÃO INICIAL MAN Impl. PL - APP/ RL",
"irrigacao inicial man impl cd ap": "IRRIGAÇÃO INICIAL MAN Impl. PL - APP/ RL",
"irrigacao inicial man madap ap": "IRRIGAÇÃO INICIAL MAN MAdap. APP/ RL",
"limpeza de area quim impl pl ap": "LIMPEZA DE ÁREA QUIM. MAN APP/RL",
"limpeza de area quim impl cd ap": "LIMPEZA DE AREA QUIM. Impl. CD APP/RL",
"eliminacao de exoticas impl pl ap": "ELIMINAÇÃO DE EXÓTICAS Impl. PL - APP/RL",
"eliminacao de exoticas impl cd ap": "ELIMINAÇÃO DE EXÓTICAS Impl. CD - APP/RL",
"coveam area nao subsol impl pl ap": "COVEAM ÁREA NÃO SUBSOL Impl. PL APP/ RL",
"coveamento motocoveador impl pl ap": "COVEAMENTO - MOTOCOVEADOR PL APP/RL",
"nucleacao em faixas impl pl ap": "NUCLEAÇÃO EM FAIXAS APP/RL",
"conducao de regeneracao impl pl ap": "CONDUÇÃO DE REGENERAÇÃO",
"preparo solo mecanizado impl mx": "PREPARO DE SOLO MEC C/ ADUB APP/RL",
"preparo solo mecanizado impl pl ap": "PREPARO DE SOLO MEC C/ ADUB APP/RL",
"preparo solo mecanizado impl mo ap": "PREPARO DE SOLO MEC C/ ADUB APP/RL",
"aplicacao herbicida pre impl mo": "CAPINA QUÍM MAN TOTAL Manut. APP/RL",
"aplicacao herbicida impl mo": "CAPINA QUÍM MAN TOTAL Manut. APP/RL",
"aplicacao quimica impl mo": "CAPINA QUÍM MAN TOTAL Manut. APP/RL",
"implantacao mecanizada impl pl ap": "PREPARO DE SOLO MEC C/ ADUB APP/RL",
"implantacao mecanizada impl mx": "PREPARO DE SOLO MEC C/ ADUB APP/RL",
"suprimento mudas impl ca": "PLANTIO MANUAL APP/RL",
"suprimento muda impl ca": "PLANTIO MANUAL APP/RL",
"adubacao quim man de cobertura impl pt": "ADUBAÇÃO QUÍM MAN 3 MESES APP/RL",
"adubacao quim man de cobertura impl pl ap": "ADUBAÇÃO QUÍM MAN 3 MESES APP/RL",
"adubacao quim man de cobertura impl mo": "ADUBAÇÃO QUÍM MAN 3 MESES APP/RL",
}

# ═══════════════════════════════════════════════════════════════════════════════
# CT317 HARDCODE HH BASE — fallback HH/HM values for CT317 operations
# ═══════════════════════════════════════════════════════════════════════════════
CT317_HARDCODE_HH_BASE = {
    ...
    "CAPINA QUÍM MAN COROA Manut. APP/RL": {"rendimento_hh": 5.4, "rendimento_hm": 0.0, "tipo": "Manual"},
    "CAPINA QUÍM MAN TOTAL MAdap. APP/RL": {"rendimento_hh": 9.0, "rendimento_hm": 0.0, "tipo": "Manual"},
    "CAPINA QUÍM MAN TOTAL Manut. APP/RL": {"rendimento_hh": 9.0, "rendimento_hm": 0.0, "tipo": "Manual"},
    "CAPINA QUÍM MEC TOTAL APP/RL": {"rendimento_hh": 0.0, "rendimento_hm": 0.95, "tipo": "Mecanizada"},
    "CAPINA QUÍM MEC TOTAL Manut. APP/RL": {"rendimento_hh": 0.0, "rendimento_hm": 0.95, "tipo": "Mecanizada"},
    ...
    "RECUPERACAO DE AREAS DEGRADADAS": {"rendimento_hh": 45.0, "rendimento_hm": 0.0, "tipo": "Manual"},
...
# ═══════════════════════════════════════════════════════════════════════════════
# COMPARATIVO MANUAL vs MECANIZADO — substitution mapping
# ═══════════════════════════════════════════════════════════════════════════════
COMPARATIVO_MANUAL_MEC = {
    ...
    # CAPINA
    "CAPINA MANUAL COROA Impl. CD APP/ RL I": "CAPINA QUÍM MEC TOTAL APP/RL",
    "CAPINA MANUAL COROA Impl. CD APP/ RL II": "CAPINA QUÍM MEC TOTAL APP/RL",
    "CAPINA MANUAL COROA Impl. CD APP/ RL III": "CAPINA QUÍM MEC TOTAL APP/RL",
    "CAPINA MANUAL COROA Impl. CD APP/ RL IV": "CAPINA QUÍM MEC TOTAL APP/RL",
    "CAPINA MANUAL COROA Impl. CD APP/ RL V": "CAPINA QUÍM MEC TOTAL APP/RL",
    "CAPINA MANUAL COROA Impl. PL - APP/ RL I": "CAPINA QUÍM MEC TOTAL APP/RL",
    "CAPINA MANUAL COROA Impl. PL - APP/ RL II": "CAPINA QUÍM MEC TOTAL APP/RL",
    "CAPINA MANUAL COROA Impl. PL - APP/ RL III": "CAPINA QUÍM MEC TOTAL APP/RL",
    "CAPINA MANUAL COROA Impl. PL - APP/ RL IV": "CAPINA QUÍM MEC TOTAL APP/RL",
    "CAPINA MANUAL COROA Impl. PL - APP/ RL V": "CAPINA QUÍM MEC TOTAL APP/RL",
    "CAPINA MANUAL COROAMENTO MAdap. APP/RL I": "CAPINA QUÍM MEC TOTAL APP/RL",
    "CAPINA MANUAL COROAMENTO MAdap. APP/RL II": "CAPINA QUÍM MEC TOTAL APP/RL",
    "CAPINA MANUAL COROAMENTO MAdap. APP/RL III": "CAPINA QUÍM MEC TOTAL APP/RL",
    "CAPINA MANUAL COROAMENTO MAdap. APP/RL IV": "CAPINA QUÍM MEC TOTAL APP/RL",
    "CAPINA MANUAL COROAMENTO MAdap. APP/RL V": "CAPINA QUÍM MEC TOTAL APP/RL",
    "CAPINA MANUAL COROAMENTO Manut. APP/RL I": "CAPINA QUÍM MEC TOTAL APP/RL",
    "CAPINA MANUAL COROAMENTO Manut. APP/RL II": "CAPINA QUÍM MEC TOTAL APP/RL",
    "CAPINA MANUAL COROAMENTO Manut. APP/RL III": "CAPINA QUÍM MEC TOTAL APP/RL",
    "CAPINA MANUAL COROAMENTO Manut. APP/RL IV": "CAPINA QUÍM MEC TOTAL APP/RL",
    "CAPINA MANUAL COROAMENTO Manut. APP/RL V": "CAPINA QUÍM MEC TOTAL APP/RL",
    # LIMPEZA DE AREA
...
# ═══════════════════════════════════════════════════════════════════════════════
# FASE CORES HEX — color mapping for Excel timeline visualization
# ═══════════════════════════════════════════════════════════════════════════════
_FASE_CORES_HEX = {
    "rocada": "4472C4",
    "formiga": "ED7D31",
